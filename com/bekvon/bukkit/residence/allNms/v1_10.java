...
implements NMS {
    ...
    public boolean isAnimal(Entity ent) {
        if (!(ent instanceof Horse || ent instanceof Bat || ent instanceof Snowman || ent instanceof IronGolem || ent instanceof Ocelot || ent instanceof Pig || ent instanceof Sheep || ent instanceof Chicken || ent instanceof Wolf || ent instanceof Cow || ent instanceof Squid || ent instanceof Villager || ent instanceof Rabbit || ent instanceof PolarBear)) {
            return false;
        }
        return true;
    }
    ...
    public boolean isCanUseEntity_BothClick(Material mat, Block block) {
        switch (v1_10.$SWITCH_TABLE$org$bukkit$Material()[mat.ordinal()]) {
            case 30: 
            case 34: 
            case 65: 
            case 70: 
    ...
    public boolean isEmptyBlock(Block block) {
        switch (v1_10.$SWITCH_TABLE$org$bukkit$Material()[block.getType().ordinal()]) {
            case 1: 
            case 7: 
            case 31: 
            case 69: 
