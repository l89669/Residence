...
implements NMS {
    ...
    public boolean isCanUseEntity_BothClick(Material mat, Block block) {
        switch (v1_7_Couldron.$SWITCH_TABLE$org$bukkit$Material()[mat.ordinal()]) {
            case 30: 
            case 34: 
            case 65: 
            case 70: 
    ...
    public boolean isEmptyBlock(Block block) {
        switch (v1_7_Couldron.$SWITCH_TABLE$org$bukkit$Material()[block.getType().ordinal()]) {
            case 1: 
            case 7: 
            case 31: 
            case 69: 
