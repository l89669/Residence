...
public class bank
implements cmd {
    @CommandAnnotation(simple=1, priority=3400)
    @Override
    ...
    public void getLocale(ConfigReader c, String path) {
        c.get(String.valueOf(path) + "Description", "Manage money in a Residence");
        c.get(String.valueOf(path) + "Info", Arrays.asList("&eUsage: &6/res bank [deposit/withdraw] <residence> [amount]", "You must be standing in a Residence or provide residence name", "You must have the +bank flag."));
